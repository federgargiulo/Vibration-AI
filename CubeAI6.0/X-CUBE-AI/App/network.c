...
#define AI_NETWORK_MODEL_SIGNATURE     "788b8b3bd2b933f758e335bb4c911137"
...
#define AI_TOOLS_DATE_TIME   "Tue Feb 21 18:55:01 2023"
...
AI_STATIC ai_array dense_input_output_array;   /* Array #0 */
...
AI_STATIC ai_array nl_2_output_array;   /* Array #4 */
...
AI_STATIC ai_tensor dense_input_output;   /* Tensor #0 */
...
AI_STATIC ai_tensor nl_2_output;   /* Tensor #4 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 2, 10, 1, 1), AI_STRIDE_INIT(4, 4, 8, 80, 80),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 44, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &dense_input_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    nl_2_output_array.data = AI_PTR(NULL);
    nl_2_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_0_bias_array.data = AI_PTR(weights + 80);
    dense_0_bias_array.data_start = AI_PTR(weights + 80);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 120);
    dense_1_weights_array.data_start = AI_PTR(weights + 120);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 160);
    dense_1_bias_array.data_start = AI_PTR(weights + 160);
  }
