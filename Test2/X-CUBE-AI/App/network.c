...
#define AI_NETWORK_MODEL_SIGNATURE     "5d2cbc457bff1f52b6d02dd2c8a54bd3"
...
#define AI_TOOLS_DATE_TIME   "Mon Feb 20 11:24:52 2023"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 6, 10, 1, 1), AI_STRIDE_INIT(4, 4, 24, 240, 240),
