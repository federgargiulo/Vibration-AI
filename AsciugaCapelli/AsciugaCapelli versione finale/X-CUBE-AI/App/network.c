...
#define AI_NETWORK_MODEL_SIGNATURE     "3939f5c04b8a2df8caa875e7b91e25ec"
...
#define AI_TOOLS_DATE_TIME   "Fri Feb 24 15:03:17 2023"
...
AI_STATIC ai_array serving_default_dense_input0_output_array;   /* Array #0 */
...
AI_STATIC ai_array nl_3_output_array;   /* Array #6 */
AI_STATIC ai_array dense_0_weights_array;   /* Array #7 */
AI_STATIC ai_array dense_0_bias_array;   /* Array #8 */
...
AI_STATIC ai_tensor serving_default_dense_input0_output;   /* Tensor #0 */
...
AI_STATIC ai_tensor nl_3_output;   /* Tensor #6 */
AI_STATIC ai_tensor dense_0_weights;   /* Tensor #7 */
AI_STATIC ai_tensor dense_0_bias;   /* Tensor #8 */
