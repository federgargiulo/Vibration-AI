...
#define AI_NETWORK_MODEL_SIGNATURE     "984aaecebd96f0b28e299dcc9c757182"
...
#define AI_TOOLS_DATE_TIME   "Mon Mar 13 19:15:19 2023"
...
AI_STATIC ai_array serving_default_dense_4_input0_output_array;   /* Array #0 */
...
AI_STATIC ai_array nl_4_output_array;   /* Array #8 */
AI_STATIC ai_array dense_0_weights_array;   /* Array #9 */
AI_STATIC ai_array dense_0_bias_array;   /* Array #10 */
AI_STATIC ai_array dense_1_weights_array;   /* Array #11 */
AI_STATIC ai_array dense_1_bias_array;   /* Array #12 */
AI_STATIC ai_array dense_2_weights_array;   /* Array #13 */
AI_STATIC ai_array dense_2_bias_array;   /* Array #14 */
AI_STATIC ai_array dense_3_weights_array;   /* Array #15 */
AI_STATIC ai_array dense_3_bias_array;   /* Array #16 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor serving_default_dense_4_input0_output;   /* Tensor #0 */
...
AI_STATIC ai_tensor nl_4_output;   /* Tensor #8 */
AI_STATIC ai_tensor dense_0_weights;   /* Tensor #9 */
AI_STATIC ai_tensor dense_0_bias;   /* Tensor #10 */
AI_STATIC ai_tensor dense_1_weights;   /* Tensor #11 */
AI_STATIC ai_tensor dense_1_bias;   /* Tensor #12 */
AI_STATIC ai_tensor dense_2_weights;   /* Tensor #13 */
AI_STATIC ai_tensor dense_2_bias;   /* Tensor #14 */
AI_STATIC ai_tensor dense_3_weights;   /* Tensor #15 */
AI_STATIC ai_tensor dense_3_bias;   /* Tensor #16 */
...
AI_STATIC_CONST ai_tensor_chain nl_4_chain;   /* Chain #7 */
...
AI_STATIC ai_layer_nl nl_4_layer; /* Layer #7 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 6, 25, 1, 1), AI_STRIDE_INIT(4, 4, 24, 600, 600),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 25, 25, 1, 1), AI_STRIDE_INIT(4, 4, 100, 2500, 2500),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  15, 0x0,
  AI_SHAPE_INIT(4, 25, 3, 1, 1), AI_STRIDE_INIT(4, 4, 100, 300, 300),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 200, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_dense_4_input0_output),
